...
/*
MEMORY LAYOUT: 
u64 : capacity : max elements that can be held
u64 : length   : numver of elements currently held
...
KAPI void _darray_field_set(void *array, u64 field, u64 values);
...
// some type magic to get a void* from a non pointer call.
// could use __auto_type instead.
